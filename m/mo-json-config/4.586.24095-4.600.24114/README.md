# Comparing `tmp/mo-json-config-4.586.24095.tar.gz` & `tmp/mo_json_config-4.600.24114.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "mo-json-config-4.586.24095.tar", last modified: Thu Apr  4 13:01:12 2024, max compression
+gzip compressed data, was "mo_json_config-4.600.24114.tar", last modified: Tue Apr 23 01:23:47 2024, max compression
```

## Comparing `mo-json-config-4.586.24095.tar` & `mo_json_config-4.600.24114.tar`

### file list

```diff
@@ -1,17 +1,17 @@
-drwxrwxrwx   0        0        0        0 2024-04-04 13:01:12.316102 mo-json-config-4.586.24095/
--rw-rw-rw-   0        0        0    16725 2019-11-12 21:32:58.000000 mo-json-config-4.586.24095/LICENSE.txt
--rw-rw-rw-   0        0        0    11685 2024-04-04 13:01:12.315014 mo-json-config-4.586.24095/PKG-INFO
--rw-rw-rw-   0        0        0     9939 2024-03-08 02:34:29.000000 mo-json-config-4.586.24095/README.md
-drwxrwxrwx   0        0        0        0 2024-04-04 13:01:12.294105 mo-json-config-4.586.24095/mo_json_config/
--rw-rw-rw-   0        0        0    11234 2024-03-10 19:25:57.000000 mo-json-config-4.586.24095/mo_json_config/__init__.py
--rw-rw-rw-   0        0        0     2411 2023-04-29 14:14:40.000000 mo-json-config-4.586.24095/mo_json_config/configuration.py
--rw-rw-rw-   0        0        0      697 2023-06-02 01:48:46.000000 mo-json-config-4.586.24095/mo_json_config/convert.py
--rw-rw-rw-   0        0        0     3113 2024-03-08 02:34:29.000000 mo-json-config-4.586.24095/mo_json_config/ssm.py
-drwxrwxrwx   0        0        0        0 2024-04-04 13:01:12.313973 mo-json-config-4.586.24095/mo_json_config.egg-info/
--rw-rw-rw-   0        0        0    11685 2024-04-04 13:01:12.000000 mo-json-config-4.586.24095/mo_json_config.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      326 2024-04-04 13:01:12.000000 mo-json-config-4.586.24095/mo_json_config.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-04-04 13:01:12.000000 mo-json-config-4.586.24095/mo_json_config.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0      207 2024-04-04 13:01:12.000000 mo-json-config-4.586.24095/mo_json_config.egg-info/requires.txt
--rw-rw-rw-   0        0        0       15 2024-04-04 13:01:12.000000 mo-json-config-4.586.24095/mo_json_config.egg-info/top_level.txt
--rw-rw-rw-   0        0        0       42 2024-04-04 13:01:12.316102 mo-json-config-4.586.24095/setup.cfg
--rw-rw-rw-   0        0        0    11541 2024-04-04 13:01:08.000000 mo-json-config-4.586.24095/setup.py
+drwxrwxrwx   0        0        0        0 2024-04-23 01:23:47.229346 mo_json_config-4.600.24114/
+-rw-rw-rw-   0        0        0    16725 2019-11-12 21:32:58.000000 mo_json_config-4.600.24114/LICENSE.txt
+-rw-rw-rw-   0        0        0    11685 2024-04-23 01:23:47.229346 mo_json_config-4.600.24114/PKG-INFO
+-rw-rw-rw-   0        0        0     9939 2024-03-08 02:34:29.000000 mo_json_config-4.600.24114/README.md
+drwxrwxrwx   0        0        0        0 2024-04-23 01:23:47.208343 mo_json_config-4.600.24114/mo_json_config/
+-rw-rw-rw-   0        0        0    11234 2024-03-10 19:25:57.000000 mo_json_config-4.600.24114/mo_json_config/__init__.py
+-rw-rw-rw-   0        0        0     2411 2023-04-29 14:14:40.000000 mo_json_config-4.600.24114/mo_json_config/configuration.py
+-rw-rw-rw-   0        0        0      697 2023-06-02 01:48:46.000000 mo_json_config-4.600.24114/mo_json_config/convert.py
+-rw-rw-rw-   0        0        0     3113 2024-03-08 02:34:29.000000 mo_json_config-4.600.24114/mo_json_config/ssm.py
+drwxrwxrwx   0        0        0        0 2024-04-23 01:23:47.222208 mo_json_config-4.600.24114/mo_json_config.egg-info/
+-rw-rw-rw-   0        0        0    11685 2024-04-23 01:23:47.000000 mo_json_config-4.600.24114/mo_json_config.egg-info/PKG-INFO
+-rw-rw-rw-   0        0        0      326 2024-04-23 01:23:47.000000 mo_json_config-4.600.24114/mo_json_config.egg-info/SOURCES.txt
+-rw-rw-rw-   0        0        0        1 2024-04-23 01:23:47.000000 mo_json_config-4.600.24114/mo_json_config.egg-info/dependency_links.txt
+-rw-rw-rw-   0        0        0      207 2024-04-23 01:23:47.000000 mo_json_config-4.600.24114/mo_json_config.egg-info/requires.txt
+-rw-rw-rw-   0        0        0       15 2024-04-23 01:23:47.000000 mo_json_config-4.600.24114/mo_json_config.egg-info/top_level.txt
+-rw-rw-rw-   0        0        0       42 2024-04-23 01:23:47.229346 mo_json_config-4.600.24114/setup.cfg
+-rw-rw-rw-   0        0        0    11541 2024-04-23 01:23:42.000000 mo_json_config-4.600.24114/setup.py
```

### Comparing `mo-json-config-4.586.24095/LICENSE.txt` & `mo_json_config-4.600.24114/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `mo-json-config-4.586.24095/PKG-INFO` & `mo_json_config-4.600.24114/PKG-INFO`
...
### Comparing `mo-json-config-4.586.24095/README.md` & `mo_json_config-4.600.24114/README.md`

 * *Files identical despite different names*

### Comparing `mo-json-config-4.586.24095/mo_json_config/__init__.py` & `mo_json_config-4.600.24114/mo_json_config/__init__.py`

 * *Files identical despite different names*

### Comparing `mo-json-config-4.586.24095/mo_json_config/configuration.py` & `mo_json_config-4.600.24114/mo_json_config/configuration.py`

 * *Files identical despite different names*

### Comparing `mo-json-config-4.586.24095/mo_json_config/convert.py` & `mo_json_config-4.600.24114/mo_json_config/convert.py`

 * *Files identical despite different names*

### Comparing `mo-json-config-4.586.24095/mo_json_config/ssm.py` & `mo_json_config-4.600.24114/mo_json_config/ssm.py`

 * *Files identical despite different names*

### Comparing `mo-json-config-4.586.24095/mo_json_config.egg-info/PKG-INFO` & `mo_json_config-4.600.24114/mo_json_config.egg-info/PKG-INFO`
...
### Comparing `mo-json-config-4.586.24095/setup.py` & `mo_json_config-4.600.24114/setup.py`
...
-    extras_require={"tests":["mo-testing>=7.562.24075","keyring>=25.1.0","boto3>=1.34.77","pyyaml","moto>=4.2.14"]},
-    install_requires=["hjson","mo-dots==9.584.24095","mo-files==6.585.24095","mo-future==7.584.24095","mo-json==6.584.24095","mo-logs==8.584.24095","requests"],
+    extras_require={"tests":["mo-testing>=7.585.24095","keyring>=25.1.0","boto3>=1.34.77","pyyaml","moto>=4.2.14"]},
+    install_requires=["hjson","mo-dots==9.600.24114","mo-files==6.600.24114","mo-future==7.584.24095","mo-json==6.600.24114","mo-logs==8.600.24114","requests"],
     license='MPL 2.0',
