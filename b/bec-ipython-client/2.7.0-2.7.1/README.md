# Comparing `tmp/bec_ipython_client-2.7.0.tar.gz` & `tmp/bec_ipython_client-2.7.1.tar.gz`
...
### Comparing `bec_ipython_client-2.7.0/PKG-INFO` & `bec_ipython_client-2.7.1/PKG-INFO`
