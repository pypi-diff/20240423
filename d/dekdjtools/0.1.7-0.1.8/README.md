# Comparing `tmp/dekdjtools-0.1.7.tar.gz` & `tmp/dekdjtools-0.1.8.tar.gz`
...
### Comparing `dekdjtools-0.1.7/dekdjtools/admin/base/__init__.py` & `dekdjtools-0.1.8/dekdjtools/admin/base/__init__.py`
