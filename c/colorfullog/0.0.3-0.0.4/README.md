# Comparing `tmp/colorfullog-0.0.3.tar.gz` & `tmp/colorfullog-0.0.4.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "colorfullog-0.0.3.tar", last modified: Wed Apr 17 15:35:37 2024, max compression
+gzip compressed data, was "colorfullog-0.0.4.tar", last modified: Tue Apr 23 03:11:56 2024, max compression
```

## Comparing `colorfullog-0.0.3.tar` & `colorfullog-0.0.4.tar`

### file list

```diff
@@ -1,13 +1,17 @@
-drwxrwxr-x   0 ares      (1000) ares      (1000)        0 2024-04-17 15:35:37.439731 colorfullog-0.0.3/
--rw-rw-r--   0 ares      (1000) ares      (1000)      444 2024-04-17 15:35:37.439731 colorfullog-0.0.3/PKG-INFO
--rw-r--r--   0 ares      (1000) ares      (1000)      518 2024-04-17 06:47:59.000000 colorfullog-0.0.3/README.md
-drwxrwxr-x   0 ares      (1000) ares      (1000)        0 2024-04-17 15:35:37.439731 colorfullog-0.0.3/colorfullog/
--rw-r--r--   0 ares      (1000) ares      (1000)       90 2024-04-17 07:14:01.000000 colorfullog-0.0.3/colorfullog/__init__.py
--rw-r--r--   0 ares      (1000) ares      (1000)     3245 2018-06-21 03:15:57.000000 colorfullog-0.0.3/colorfullog/colorfullog.py
-drwxrwxr-x   0 ares      (1000) ares      (1000)        0 2024-04-17 15:35:37.439731 colorfullog-0.0.3/colorfullog.egg-info/
--rw-rw-r--   0 ares      (1000) ares      (1000)      444 2024-04-17 15:35:37.000000 colorfullog-0.0.3/colorfullog.egg-info/PKG-INFO
--rw-rw-r--   0 ares      (1000) ares      (1000)      219 2024-04-17 15:35:37.000000 colorfullog-0.0.3/colorfullog.egg-info/SOURCES.txt
--rw-rw-r--   0 ares      (1000) ares      (1000)        1 2024-04-17 15:35:37.000000 colorfullog-0.0.3/colorfullog.egg-info/dependency_links.txt
--rw-rw-r--   0 ares      (1000) ares      (1000)       12 2024-04-17 15:35:37.000000 colorfullog-0.0.3/colorfullog.egg-info/top_level.txt
--rw-r--r--   0 ares      (1000) ares      (1000)       38 2024-04-17 15:35:37.439731 colorfullog-0.0.3/setup.cfg
--rw-r--r--   0 ares      (1000) ares      (1000)     1315 2024-04-17 15:35:14.000000 colorfullog-0.0.3/setup.py
...
### Comparing `colorfullog-0.0.3/README.md` & `colorfullog-0.0.4/README.md`

 * *Files identical despite different names*

### Comparing `colorfullog-0.0.3/colorfullog/colorfullog.py` & `colorfullog-0.0.4/colorfullog/colorfullog.py`

 * *Files identical despite different names*

### Comparing `colorfullog-0.0.3/setup.py` & `colorfullog-0.0.4/setup.py`
