# Comparing `tmp/TitanDevice-0.1.5.tar.gz` & `tmp/TitanDevice-0.1.6.tar.gz`
...
## Comparing `TitanDevice-0.1.5.tar` & `TitanDevice-0.1.6.tar`
...
### Comparing `TitanDevice-0.1.5/PKG-INFO` & `TitanDevice-0.1.6/PKG-INFO`
...
### Comparing `TitanDevice-0.1.5/TitanDevice.egg-info/PKG-INFO` & `TitanDevice-0.1.6/TitanDevice.egg-info/PKG-INFO`
...
### Comparing `TitanDevice-0.1.5/setup.py` & `TitanDevice-0.1.6/setup.py`
...
### Comparing `TitanDevice-0.1.5/titan/_device_manager.py` & `TitanDevice-0.1.6/titan/_device_manager.py`
