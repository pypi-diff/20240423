# Comparing `tmp/pyarmor-8.5.4.zip` & `tmp/pyarmor-8.5.5.zip`
...
## Comparing `pyarmor-8.5.4/setup.py` & `pyarmor-8.5.5/setup.py`
...
## Comparing `pyarmor-8.5.4/pyarmor/cli/__main__.py` & `pyarmor-8.5.5/pyarmor/cli/__main__.py`
...
## Comparing `pyarmor-8.5.4/pyarmor/examples/simple/queens.py` & `pyarmor-8.5.5/pyarmor/examples/simple/queens.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/Arithmetic.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/Arithmetic.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/With.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/With.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/Lists.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/Lists.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/Tuples.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/Tuples.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/Instances.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/Instances.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/systimes.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/systimes.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/clockres.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/clockres.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/Lookups.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/Lookups.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/CommandLine.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/CommandLine.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/Numbers.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/Numbers.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/Imports.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/Imports.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/Setup.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/Setup.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/Exceptions.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/Exceptions.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/Dict.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/Dict.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/pybench.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/pybench.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/NewInstances.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/NewInstances.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/Calls.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/Calls.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/Strings.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/Strings.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/pybench/Constructs.py` & `pyarmor-8.5.5/pyarmor/examples/pybench/Constructs.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/testmod/hello.py` & `pyarmor-8.5.5/pyarmor/examples/testmod/hello.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/testmod/queens.py` & `pyarmor-8.5.5/pyarmor/examples/testmod/queens.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/py2exe/queens.py` & `pyarmor-8.5.5/pyarmor/examples/py2exe/queens.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/examples/py2exe/setup.py` & `pyarmor-8.5.5/pyarmor/examples/py2exe/setup.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/polyfills/__init__.py` & `pyarmor-8.5.5/pyarmor/polyfills/__init__.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/polyfills/argparse.py` & `pyarmor-8.5.5/pyarmor/polyfills/argparse.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/helper/superuntime.py` & `pyarmor-8.5.5/pyarmor/helper/superuntime.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/helper/merge.py` & `pyarmor-8.5.5/pyarmor/helper/merge.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/helper/buildext.py` & `pyarmor-8.5.5/pyarmor/helper/buildext.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/helper/get_platform_name.py` & `pyarmor-8.5.5/pyarmor/helper/get_platform_name.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/helper/get_license_info.py` & `pyarmor-8.5.5/pyarmor/helper/get_license_info.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/helper/get_bind_key.py` & `pyarmor-8.5.5/pyarmor/helper/get_bind_key.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/helper/build_data_module.py` & `pyarmor-8.5.5/pyarmor/helper/build_data_module.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor/helper/repack.py` & `pyarmor-8.5.5/pyarmor/helper/repack.py`

 * *Files identical despite different names*

## Comparing `pyarmor-8.5.4/pyarmor.egg-info/PKG-INFO` & `pyarmor-8.5.5/pyarmor.egg-info/PKG-INFO`
...
## Comparing `pyarmor-8.5.4/pyarmor.egg-info/SOURCES.txt` & `pyarmor-8.5.5/pyarmor.egg-info/SOURCES.txt`
