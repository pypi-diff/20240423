# Comparing `tmp/lense-0.0.7-py3-none-any.whl.zip` & `tmp/lense-0.0.8-py3-none-any.whl.zip`
...
## Comparing `lense-0.0.7.dist-info/METADATA` & `lense-0.0.8.dist-info/METADATA`
...
## Comparing `lense-0.0.7.dist-info/RECORD` & `lense-0.0.8.dist-info/RECORD`
