# Comparing `tmp/FlowVisor-0.0.1.tar.gz` & `tmp/FlowVisor-0.0.2.tar.gz`
...
+gzip compressed data, was "FlowVisor-0.0.2.tar", last modified: Tue Apr 23 15:10:06 2024, max compression
```

## Comparing `FlowVisor-0.0.1.tar` & `FlowVisor-0.0.2.tar`
...
+drwxrwxr-x   0 phil      (1000) phil      (1000)        0 2024-04-23 15:10:06.931055 FlowVisor-0.0.2/
+drwxrwxr-x   0 phil      (1000) phil      (1000)        0 2024-04-23 15:10:06.931055 FlowVisor-0.0.2/FlowVisor.egg-info/
+-rw-rw-r--   0 phil      (1000) phil      (1000)     2338 2024-04-23 15:10:06.000000 FlowVisor-0.0.2/FlowVisor.egg-info/PKG-INFO
+-rw-rw-r--   0 phil      (1000) phil      (1000)      311 2024-04-23 15:10:06.000000 FlowVisor-0.0.2/FlowVisor.egg-info/SOURCES.txt
+-rw-rw-r--   0 phil      (1000) phil      (1000)        1 2024-04-23 15:10:06.000000 FlowVisor-0.0.2/FlowVisor.egg-info/dependency_links.txt
+-rw-rw-r--   0 phil      (1000) phil      (1000)       50 2024-04-23 15:10:06.000000 FlowVisor-0.0.2/FlowVisor.egg-info/requires.txt
+-rw-rw-r--   0 phil      (1000) phil      (1000)       10 2024-04-23 15:10:06.000000 FlowVisor-0.0.2/FlowVisor.egg-info/top_level.txt
+-rw-rw-r--   0 phil      (1000) phil      (1000)     1067 2024-04-22 08:55:02.000000 FlowVisor-0.0.2/LICENSE
+-rw-rw-r--   0 phil      (1000) phil      (1000)     2338 2024-04-23 15:10:06.931055 FlowVisor-0.0.2/PKG-INFO
+-rw-rw-r--   0 phil      (1000) phil      (1000)     1700 2024-04-23 14:52:13.000000 FlowVisor-0.0.2/README.md
+drwxrwxr-x   0 phil      (1000) phil      (1000)        0 2024-04-23 15:10:06.931055 FlowVisor-0.0.2/flowvisor/
+-rw-rw-r--   0 phil      (1000) phil      (1000)       87 2024-04-23 14:16:28.000000 FlowVisor-0.0.2/flowvisor/__init__.py
+-rw-rw-r--   0 phil      (1000) phil      (1000)     7539 2024-04-23 14:40:02.000000 FlowVisor-0.0.2/flowvisor/flowvisor.py
+-rw-rw-r--   0 phil      (1000) phil      (1000)      606 2024-04-22 11:10:52.000000 FlowVisor-0.0.2/flowvisor/flowvisor_config.py
+-rw-rw-r--   0 phil      (1000) phil      (1000)     7283 2024-04-23 14:38:39.000000 FlowVisor-0.0.2/flowvisor/function_node.py
+-rw-rw-r--   0 phil      (1000) phil      (1000)     2368 2024-04-22 10:26:27.000000 FlowVisor-0.0.2/flowvisor/utils.py
+-rw-rw-r--   0 phil      (1000) phil      (1000)       38 2024-04-23 15:10:06.931055 FlowVisor-0.0.2/setup.cfg
+-rw-rw-r--   0 phil      (1000) phil      (1000)     1001 2024-04-23 15:07:02.000000 FlowVisor-0.0.2/setup.py
```

### Comparing `FlowVisor-0.0.1/LICENSE` & `FlowVisor-0.0.2/LICENSE`

 * *Files identical despite different names*

### Comparing `FlowVisor-0.0.1/flowvisor/flowvisor_config.py` & `FlowVisor-0.0.2/flowvisor/flowvisor_config.py`

 * *Files identical despite different names*

### Comparing `FlowVisor-0.0.1/flowvisor/function_node.py` & `FlowVisor-0.0.2/flowvisor/function_node.py`
...
### Comparing `FlowVisor-0.0.1/flowvisor/utils.py` & `FlowVisor-0.0.2/flowvisor/utils.py`
