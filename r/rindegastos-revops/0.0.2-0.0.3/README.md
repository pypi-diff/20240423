# Comparing `tmp/rindegastos_revops-0.0.2.tar.gz` & `tmp/rindegastos_revops-0.0.3.tar.gz`
...
## Comparing `rindegastos_revops-0.0.2.tar` & `rindegastos_revops-0.0.3.tar`
...
### Comparing `rindegastos_revops-0.0.2/PKG-INFO` & `rindegastos_revops-0.0.3/PKG-INFO`
...
### Comparing `rindegastos_revops-0.0.2/setup.cfg` & `rindegastos_revops-0.0.3/setup.cfg`
...
### Comparing `rindegastos_revops-0.0.2/src/rindegastos_revops.egg-info/PKG-INFO` & `rindegastos_revops-0.0.3/src/rindegastos_revops.egg-info/PKG-INFO`
...
### Comparing `rindegastos_revops-0.0.2/tests/test_hubspot_api_contacts.py` & `rindegastos_revops-0.0.3/tests/test_hubspot_api_contacts.py`

 * *Files 21% similar despite different names*

```diff
@@ -1,9 +1,9 @@
-from src.hubspot_api.objects.contacts.search import Search
-from src.hubspot_api.helpers.hubspot import HubspotConnectorApi
