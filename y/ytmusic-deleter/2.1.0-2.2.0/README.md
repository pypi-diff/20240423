# Comparing `tmp/ytmusic_deleter-2.1.0.tar.gz` & `tmp/ytmusic_deleter-2.2.0.tar.gz`
...
## Comparing `ytmusic_deleter-2.1.0.tar` & `ytmusic_deleter-2.2.0.tar`
...
### Comparing `ytmusic_deleter-2.1.0/auth.py` & `ytmusic_deleter-2.2.0/ytmusic_deleter/auth.py`
...
### Comparing `ytmusic_deleter-2.1.0/uploads.py` & `ytmusic_deleter-2.2.0/ytmusic_deleter/uploads.py`
