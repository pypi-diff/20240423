# Comparing `tmp/onnxsharp-0.0.2-py2.py3-none-any.whl.zip` & `tmp/onnxsharp-0.0.3-py2.py3-none-any.whl.zip`
...
## Comparing `onnxsharp-0.0.2.data/scripts/ort_get_peak_op_summary` & `onnxsharp-0.0.3.data/scripts/ort_get_peak_op_summary`

 * *Files identical despite different names*

## Comparing `onnxsharp-0.0.2.data/scripts/ort_parse_output_name` & `onnxsharp-0.0.3.data/scripts/ort_parse_output_name`

 * *Files identical despite different names*

## Comparing `onnxsharp-0.0.2.data/scripts/ort_parse_peak_summary` & `onnxsharp-0.0.3.data/scripts/ort_parse_peak_summary`

 * *Files identical despite different names*

## Comparing `onnxsharp-0.0.2.dist-info/LICENSE` & `onnxsharp-0.0.3.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `onnxsharp-0.0.2.dist-info/METADATA` & `onnxsharp-0.0.3.dist-info/METADATA`
...
## Comparing `onnxsharp-0.0.2.dist-info/RECORD` & `onnxsharp-0.0.3.dist-info/RECORD`
...
-onnxsharp-0.0.2.data/scripts/ort_get_peak_details,sha256=dyu4V87LWycofXjrVJhYBDgS5KrDFMlZZxHfsidSzsk,462
-onnxsharp-0.0.2.data/scripts/ort_get_peak_op_summary,sha256=BWR9hKaE93cp8lJXZMo2BEHEeMBhUzPYS3DDv_CGpjM,5491
-onnxsharp-0.0.2.data/scripts/ort_get_peak_step,sha256=pjB_RgbFpxaoV6UP2ZyenkoJgKaEULOEedhouHrEcVM,237
-onnxsharp-0.0.2.data/scripts/ort_get_peak_summary,sha256=-jFR5STrbW2owiyXlMfWr63KC71GPHETAM5uaOlju5c,269
-onnxsharp-0.0.2.data/scripts/ort_parse_output_name,sha256=Aw5iWm3nenykAhw2koKrNCb5xupIfOSykEw7d76nCz0,1911
-onnxsharp-0.0.2.data/scripts/ort_parse_peak_summary,sha256=U9xmziK-LBqK7ScLpbkOLlVWnEv0LgRG_qpN5w4qVKE,2436
-onnxsharp-0.0.2.data/scripts/ort_scan_output_in_order,sha256=2t1UGvjatbDVXDMwI1TNwAsVPAlIoJ7QbTf4wCr2HjQ,256
-onnxsharp-0.0.2.dist-info/LICENSE,sha256=SbvpEU5JIU3yzMMkyzrI0dGqHDoJR_lMKGdl6GZHsy4,11558
-onnxsharp-0.0.2.dist-info/METADATA,sha256=-rRcAnC6bHFiXuaHJ4AWYWiEeH71QXGt8zfMzIOjHzg,1118
-onnxsharp-0.0.2.dist-info/WHEEL,sha256=Z-nyYpwrcSqxfdux5Mbn_DQ525iP7J2DG3JgGvOYyTQ,110
-onnxsharp-0.0.2.dist-info/top_level.txt,sha256=hbt5uElu_gcJ_NZYK75bQjYKmLaN0otbjrU1-oByi2s,10
-onnxsharp-0.0.2.dist-info/RECORD,,
